...
| getDiffTree | 获取两个json对象的区别 | patch(newArr: TreeNodeType[], oldArr: TreeNodeType[], option = { indexEffect: true })<br/>1. 新树<br/>2.旧树<br/>3.是否受index排序影响                                                    | `{updates, deletes, adds, moves}` |
